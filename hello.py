...
if __name__ == "__main__":
    ...
    MY_API_KEY = "1dfJHPGvt1weWgPjU44aFdM8LSS9UyzfzuuTMr68z9473qAvdSr3tFJ9ynxLKTAqneenN3LmQUD44Ynf2FxMRuVZHKHEBQkk6Cn8ZFKZcYQvGcvxN2gY"
    MY_SATELLITE = "12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S@us1.storj.io:7777"
    MY_BUCKET = "uplink"
    MY_STORJ_UPLOAD_PATH = "luis/ipfs.png"
    # (path + filename) OR filename
    MY_ENCRYPTION_PASSPHRASE = "x9N49B&nX6*58Q"

    # Source and destination path and file name for testing
    SRC_FULL_FILENAME = "/Users/cloudninja/Desktop/ipfs.png"
